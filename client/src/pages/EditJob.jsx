        ...
        <div className={`rounded-2xl overflow-hidden border ${darkMode ? 'bg-slate-800/90 border-slate-700/50' : 'bg-white/90 border-gray-200/50'}`}>
          ...
          <div className="p-6 sm:p-8">
            <div className="flex items-center gap-4 mb-8">
              ...
              <div>
                <h1 className={`text-2xl font-bold ${darkMode ? 'text-white' : 'text-gray-900'}`}>Edit Job</h1>
                <p className={darkMode ? 'text-gray-400' : 'text-gray-500'}>Update your job application</p>
              </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="flex gap-4 pt-4">
                ...
                <button
                  type="submit"
                  disabled={saving}
                  className="flex-1 bg-gradient-to-r from-amber-500 to-orange-500 py-3 rounded-xl text-white font-semibold disabled:opacity-50 hover:shadow-lg hover:shadow-amber-500/25 transition-all"
                >
                  {saving ? (
